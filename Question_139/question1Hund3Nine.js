...
var _this = this;
var funcProm = function (val) {
    return new Promise(function (resolve, reject) {
        var add = 5 + val;
        resolve(add);
    });
};
var asycAwat = function () { return __awaiter(_this, void 0, void 0, function () {
    var resOne, resTwo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, funcProm(5)];
            case 1:
                resOne = _a.sent();
                return [4 /*yield*/, funcProm(resOne)];
            case 2:
                resTwo = _a.sent();
                console.log(resTwo);
                return [2 /*return*/];
